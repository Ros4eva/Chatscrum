...
def perform_user_login(driver, after_signup=True, data=None):
    driver.maximize_window()
    try:
        time.sleep(4)
        ...
        driver.find_element_by_name("projname").click()
        driver.find_element_by_name("projname").clear()
        driver.find_element_by_name("projname").send_keys("firstProject")


        el = driver.find_element_by_xpath("//*[@id='btn-one']").click()

        print("\nSuccessfully Logged In", data['email'])
        driver.execute_script("arguments[0].click();", el)

        time.sleep(5)
    except Exception as e:
        print("test_perform_user_login: ", e)

def perform_login(driver, after_signup=True, data=None):
    driver.maximize_window()
    try:
        time.sleep(4)
        ...
        print("test_perform_valid_login: ", e)


def perform_fake_login(driver, after_signup=True):
    driver.maximize_window()
    try:
        time.sleep(4)
        ...
        driver.find_element_by_name("email").click()
        driver.find_element_by_name("email").clear()
        driver.find_element_by_name("email").send_keys("justarandom@mail.com")
        time.sleep(1)


        driver.find_element_by_name("password").click()
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("justarandompass#")
        time.sleep(1)


        driver.find_element_by_name("projname").click()
        driver.find_element_by_name("projname").clear()
        driver.find_element_by_name("projname").send_keys(" Random Project Name")
        ...
        print("test_perform_fake_login: ", e)
